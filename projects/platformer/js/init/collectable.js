(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 600, 75, 10, 0.5);
        collectable.create(type.steve, 225, 250, 10, 0.5);
        collectable.create(type.steve, 600, 350, 10, 0.5);
        collectable.create(type.steve, 255, 425, 10, 0.5);
